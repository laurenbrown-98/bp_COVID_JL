...
# Each serial interval is a random delay drawn from a lognormal distribution
...
# making plot
plot1 <- ggplot(dd_out, aes(x = date)) +
...
ggsave(plot = plot1, filename = "bp_forecast.jpeg", device = "jpeg")